...
[Tue May 05 08:09:02] albert@albert-VirtualBox:~
$ pipx install graphifyy && graphify install
Command 'pipx' not found, but can be installed with:
sudo apt install pipx

[Tue May 05 08:09:19] albert@albert-VirtualBox:~
$ sudo apt install pipx
...
Tue May 05 08:09:50] albert@albert-VirtualBox:~
$ pipx install graphifyy && graphify install
  installed package graphifyy 0.7.5, installed using Python 3.12.3
  These apps are now globally available
    - graphify
done! ✨ 🌟 ✨
  skill installed  ->  /home/albert/.claude/skills/graphify/SKILL.md
  CLAUDE.md        ->  created at /home/albert/.claude/CLAUDE.md
...
- Never run HTML viz on a graph with more than 5,000 nodes without warning the user.
  query "Explain in simple words how Context works"
